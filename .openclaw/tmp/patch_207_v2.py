...
# Insert right before "def select_kraken_model(" at module level
insert_before = "\n\ndef select_kraken_model("
if insert_before in content:
    content = content.replace(insert_before, new_methods + "\n\ndef select_kraken_model(", 1)
    ...
    result = subprocess.run(
        ["python3", "-m", "py_compile",
         "/home/dh/agentic_historian/agentic_historian/agent_a/model_selector.py"],
    ...
    idx = content.find("def select_kraken_model")
