...
- [x] **AH-11** · P1 · Validate VLM choice for medieval hands. Done 2026-09-07 on the Inzigkofen ground-truth set (291 lines / 8 pages): the qwen3-vl-* models are no longer served at all; `qwen3.8-27b` reads the page at 27.7 % CER, `internvl3-8b` collapses (189.8 %). `GPUSTACK_MODEL_VISION` now defaults to `qwen3.8-27b`. _Refs:_ docs/PIPELINE_CONSEQUENCES.md §1 and §6, audit §2.1.
