...
def describe(doc_id: str, transcription: str, image_path: Optional[str] = None) -> dict:
    ...
    full_prompt = (
        ...
        "JSON-Schema (16 Elemente, Pflichtfelder):\n"
        ...
        "- Fehlende oder nicht beobachtbare Felder mit null oder [] je nach Typ.\n"
        "- Unsichere Angaben: im betreffenden Element unsicher: true setzen (kein Kommentar).\n"
    )
